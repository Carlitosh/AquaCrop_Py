...
netcdf_dimensions[aquacrop_variable_name] = ('rotation','time','depth','lat','lon')
...
netcdf_dimensions[aquacrop_variable_name] = ('rotation','time','lat','lon')
...
# netcdf_dimensions                         = ('rotation','lat','lon')
...
# netcdf_dimensions                         = ('rotation','depth','lat','lon')
# netcdf_unit[aquacrop_variable_name]       = '1'
# netcdf_long_name[aquacrop_variable_name]  = None
# description[aquacrop_variable_name]       = None
# comment[aquacrop_variable_name]           = None
